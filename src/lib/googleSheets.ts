...
export async function submitApplication(data: Record<string, string>) {
  // In a real scenario, this would post to a Google Sheets Web App endpoint or webhook (like Zapier/Formspree)
  // Example:
  ...
  return new Promise(resolve => {
    console.log("Mock application saved to Sheets:", data);
