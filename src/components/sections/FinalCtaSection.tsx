  ...
  return (
    <section className={`py-16 md:py-32 px-4 md:px-6 ${theme === 'dark' ? 'bg-zinc-950' : 'bg-white'} text-center relative overflow-hidden`}>
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <h2 className={`text-5xl md:text-8xl font-black tracking-tighter mb-4 md:mb-6 leading-[0.85]`}>
          it's time to train<br className="hidden md:block"/>
          <span className="text-amber-500"> at a higher level</span>
        </h2>
        <p className={`text-base md:text-xl ${theme === 'dark' ? 'text-zinc-400' : 'text-zinc-600'} mb-8 md:mb-10 font-medium`}>
        ...
        <div className="flex flex-col items-center gap-5">
           ...
           <a href="https://calendly.com/apexmovement/strategy" target="_blank" rel="noreferrer" className={`text-xs ${theme === 'dark' ? 'text-zinc-400 hover:text-zinc-300' : 'text-zinc-500 hover:text-zinc-700'} font-bold underline decoration-zinc-500/30 underline-offset-4 mt-2`}>
