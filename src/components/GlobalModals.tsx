        ...
        {activeManual && (
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tighter mb-4 md:mb-6 leading-none break-words">
                {activeManual.title}
              </h2>
              <div className="text-lg md:text-xl font-medium opacity-60 italic mb-8 md:mb-12">
                "{activeManual.law}"
              </div>
              <div className="space-y-6 md:space-y-8">
                <div>
                  ...
                  <p className="text-sm md:text-base font-medium opacity-80 leading-relaxed">{activeManual.intro}</p>
                </div>
                {activeManual.why && (
                  <div>
                    ...
                    <p className="text-sm md:text-base font-medium opacity-80 leading-relaxed">{activeManual.why}</p>
                  </div>
                )}
                {activeManual.how && activeManual.how.length > 0 && (
                  <div>
                    ...
                    <ul className="space-y-3 md:space-y-4 text-sm md:text-base font-medium opacity-80">
        ...
        {activeProject && (
          <div className="flex flex-col md:flex-row gap-8 md:gap-16">
            <div className="md:w-1/2">
              ...
              <div className="space-y-6 md:space-y-8">
                <p className="text-sm md:text-base font-medium opacity-80 leading-relaxed">{activeProject.detail || activeProject.description}</p>
              </div>
              {activeProject.link && (
                <Button 
